...
<div class="row">
	<form role="form" action="{{{URL::to('erppurchaseorder/adddetails/'.$order->id)}}}" method="POST">
			
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
			<h3>Additional Details</h3>
			<div class="form-group">
            <label for="username">Header :</label>
            <input class="form-control" placeholder="" type="text" name="header" id="header" value="{{$order->purchase_header}}">
        </div>


         <div class="form-group">
            <label for="username">Other Details:</label>
            <textarea rows="20" class="form-control" name="purchase_details" id="purchase_details" >{{$order->purchase_details}}</textarea>
        </div>
    </div>
